...
//        String pwd = passwordEncode.encode("123456");
        String pwd = "123456";
        manager.createUser(User.withUsername("user_1").password(passwordEncoder().encode(pwd)).authorities("USER").build());
        manager.createUser(User.withUsername("user_2").password(passwordEncode.encode(pwd)).authorities("USER").build());
        return manager;
